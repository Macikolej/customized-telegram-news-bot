...
def respond():
    ...
    if "/start" in text:
        bot.sendMessage(chat_id=chat_id, text="ok, instructions", reply_to_message_id=msg_id, reply_markup=telegram.InlineKeyboardMarkup([[telegram.InlineKeyboardButton("➡️ Configuration", web_app=telegram.WebAppInfo("https://macikolej.github.io/telegram-bot-configuration/"))]]))
